...
Gem::Specification.new do |s|
  ...
  s.email       = ["info@creditsaint.com"]
  s.homepage    = "https://github.com/swagger-api/swagger-codegen"
  s.summary     = "Acqualify API Documentation Ruby Gem"
  s.description = "The Acqualify API provides services to mortgage brokers and realtors to help applicants qualify for loans."
  s.license     = "Unlicense"
